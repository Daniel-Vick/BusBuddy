...
public class MainActivity extends FragmentActivity {
    ...
    public void moveToActivity2(View view){
        ...
        String destination = autoCompView.getText().toString();
        intent.putExtra("BLARG", destination);
    ...
    private static final String API_KEY = "AIzaSyDq9FYAMUDiOuXjo7Y1Lc-bWxb0u4rCp9Q";
    ...
    //package com.example.jeremy.blarg;
